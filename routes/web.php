...
//================================new ===========
    ...
    Route::middleware('RoleAuth')->group(function () {
        ...
        // Route::resource('reservations', ReservationController::class);
          ...
          //==Organizer================================================================
        Route::get('organizer/report',[OrganizerController::class,'report'])->name('organizers.report');
        Route::get('organizer/rreport_reservation_filteredeport',[OrganizerController::class,'reportReservationFiltered'])->name('organizers.reportReservationFiltered');

        Route::get('organizer/previous_reservations',[OrganizerController::class,'previousReservations'])->name('organizers.previous_reservations');
        Route::get('organizer/previous_reservations_filtered',[OrganizerController::class,'previousReservationsFiltered'])->name('organizers.previousReservationFiltered');

        Route::get('organizer/future_reservations',[OrganizerController::class,'futureReservations'])->name('organizers.future_reservations');
        Route::get('organizer/future_reservations_filtered',[OrganizerController::class,'futureReservationsFiltered'])->name('organizers.futureReservationFiltered');
