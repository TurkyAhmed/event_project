    ...
    <div class="container px-5">
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-8 col-xl-6">
                    ...
                    <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="POST" action="">
                        ...
                        <!-- Subject input-->
                        <div class="form-floating mb-3">
                            <input name="subject" class="form-control" id="subject" type="text" placeholder="Subject" data-sb-validations="required" />
                        ...
                        <!-- Submit Button-->
                        <div class="d-grid"><button class="btn btn-dark btn-lg" id="submitButton" type="submit" name="submit">Submit</button></div>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="row gx-5 row-cols-2 row-cols-lg-4 py-5">
            ...
            <div class="col">
                ...
                <p class="text-muted mb-0">Call us during normal business hours at +967 739531388.</p>
            </div>
        </div>
    </div>
</section>
